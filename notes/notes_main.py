...
from email_storage import get_emails, clear_emails
...
@app.get("/api/diagnostic/emails")
def get_diagnostic_emails():
    return get_emails()

@app.delete("/api/diagnostic/emails")
def delete_diagnostic_emails():
    return clear_emails()
